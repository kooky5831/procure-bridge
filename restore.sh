...
START_DATE="2018-04-2"  # YYYY-MM-DD
END_DATE="2018-04-26"    # YYYY-MM-DD
...
commit_messages=(
    "Fix: Fix bug in login page Co-authored-by: kevin5831 <jastinmax999@gmail.com>"
    "Feat: Add new Feature for google login"
    "Feat: Refactor user authentication Co-authored-by: kevin5831 <jastinmax999@gmail.com>"
    "Fix: Feat: Improve UI for better UX Co-authored-by: kevin5831 <jastinmax999@gmail.com>"
    "Fix: Optimize database queries Co-authored-by: kevin5831 <jastinmax999@gmail.com>"
    "Fix: Fix issue with API response Co-authored-by: kevin5831 <jastinmax999@gmail.com>"
    "Feat: Add new feature for user profile Co-authored-by: kevin5831 <jastinmax999@gmail.com>"
